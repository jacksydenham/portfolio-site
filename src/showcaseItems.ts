...
export const showcaseItems: ShowcaseItem[] = [
  ...
  },
  {
    ...
    intro: "As part of Astral Consulting's KeyDocs project, I built a unified audit-logging system for our Admin Centre, capturing every configuration update and  action in a single user interface.",
    ...
    challenges: [
      { title: "Schema Flexibility", description: "One table handles 26 different events with varying complexity." },
      { title: "100% Coverage", description: "All administrative actions and config updates are tracked in full." },
      { title: "Compliance-Grade UX", description: "Consistent display of entries ensures natural readability." },
    ],
