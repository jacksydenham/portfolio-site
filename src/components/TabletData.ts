...
export const TabletMeta: TabletMeta[] = [
  { name:"React",          categories:["Frontend","UI"],               triggers:["Frontend","UI"],             primarySkill:"Core UI Components",          gridX:0, gridY:0, projects:["KeyDocs","Carer Manager Plus","Agent Bond"] },
  { name:"Next.js",        categories:["Frontend","Serverless"],       triggers:["Frontend","Serverless"],     primarySkill:"Frontend Frameworks",         gridX:1, gridY:0, projects:["KeyDocs","Agent Bond"] },
  ...
  { name:"Node.js",        categories:["Backend","API","Integration"], triggers:["Backend","API"],             primarySkill:"Backend Core",                gridX:0, gridY:1, projects:["Carer Manager Plus","Agent Bond"] },
  ...
  { name:"Teams",          categories:["Collaboration","SDLC"],        triggers:["Collaboration","SDLC"],      primarySkill:"Collaborative Workflows",     gridX:1, gridY:3, projects:["KeyDocs","Carer Manager Plus","Agent Bond"] },
  { name:"Jira",           categories:["SDLC"],                        triggers:["SDLC"],                      primarySkill:"SDLC & Project Management",   gridX:2, gridY:3, projects:["KeyDocs","Carer Manager Plus","Agent Bond"] },
  ...
  { name:"Vercel",         categories:["Cloud","Serverless"],          triggers:["Cloud","Serverless"],        primarySkill:"Cloud Hosting",               gridX:5, gridY:3, projects:["SmartBoard","Carer Manager Plus","Agent Bond"] },
];
