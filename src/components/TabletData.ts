...
export const TabletMeta: TabletMeta[] = [
  ...
  { name:"Vercel",         categories:["Cloud","Serverless"],        triggers:["Cloud","Serverless"],         primarySkill:"Cloud Hosting",               gridX:5, gridY:3, projects:["SmartBoard"] },
  ...
  { name:"Redis",          categories:["API","Integration"],         triggers:["API","Integration"],          primarySkill:"API & Integration Toolkit",   gridX:5, gridY:2, projects:["KeyDocs","Carer Manager Plus"] },
];
