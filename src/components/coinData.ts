...
export const coinMeta: CoinMeta[] = [
  ...
  { name: "REST API",              categories: ["Integration"],               gridX: 1, gridY: 0, projects: ["Keydocs", "Carer Manager Plus"] },
  ...
  { name: "JDBC",                  categories: ["Databasing"],                gridX: 3, gridY: 1, projects: ["SmartBoard"] },
  { name: "Dataverse",             categories: ["Databasing","Cloud"],        gridX: 4, gridY: 1, projects: ["Keydocs"] },
  { name: "JSON",                  categories: ["Integration"],               gridX: 5, gridY: 1, projects: ["Keydocs"] },
